  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        ...
        <p class="shop-notice ellipsis" @click="isShowBulletin=true">{{info.bulletin}}</p>
      </div>
    </div>
    <div class="shop-header-discounts" v-if="info.supports" >
      <div class="discounts-left" @click="isShowSupports=true">
    ...
    <transition name="fade-enter-active fade-leave-active fade-enter fade-leave">
